...
const JWT_ACCESS_EXPIRES_IN = process.env.JWT_ACCESS_TOKEN_EXPIRES_IN || '3600'; // in seconds
const JWT_REFRESH_EXPIRES_IN = process.env.JWT_REFRESH_TOKEN_EXPIRES_IN || '604800'; // in seconds
/**
...
export const verify = async (token: string, options?: Partial<JWTSignOptions>) => {
...
export const sign = (payload: any, options?: JWTSignOptions): Promise<string> => {
